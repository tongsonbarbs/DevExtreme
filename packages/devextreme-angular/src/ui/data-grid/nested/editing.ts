...
import { EditingOptions, dxDataGridRowObject } from 'devextreme/ui/data_grid';
...
export class DxoDataGridEditingComponent extends NestedOption implements OnDestroy, OnInit  {
    ...
    @Input()
    get allowDeleting(): boolean | ((options: EditingOptions | { component: dxDataGrid, row: dxDataGridRowObject }) => boolean) {
        return this._getOption('allowDeleting');
    }
    set allowDeleting(value: boolean | ((options: EditingOptions | { component: dxDataGrid, row: dxDataGridRowObject }) => boolean)) {
        this._setOption('allowDeleting', value);
    }

    @Input()
    get allowUpdating(): boolean | ((options: EditingOptions | { component: dxDataGrid, row: dxDataGridRowObject }) => boolean) {
        return this._getOption('allowUpdating');
    }
    set allowUpdating(value: boolean | ((options: EditingOptions | { component: dxDataGrid, row: dxDataGridRowObject }) => boolean)) {
